...
Asked whether he would name individuals from the floor, Massie answered simply: "Yes."<sup>[1](#ref-1)</sup> He has signaled that survivors could shape the list. According to The Source, Massie has said that if Epstein survivors compile a list of names, he will read those names on the floor under the protection of the clause.<sup>[2](#ref-2)</sup>
