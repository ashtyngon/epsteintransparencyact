...
summary: "A search for \"Staten Island\" in the newly released DOJ Epstein files returns hundreds of references scattered across emails, flight logs, and investigative docu"
people:
  - jeffrey-epstein
  - nancy-mace
  - pam-bondi
...
A search for "Staten Island" in the Department of Justice's Epstein files returns hundreds of references across three categories: underwear purchases, attorney records, and autopsy documentation, according to a report by SILive.com.

The Staten Island outlet identified the search results in the DOJ's February file release, which has drawn scrutiny from members of Congress who say the agency released only a fraction of documents related to the deceased financier's criminal network.

## Three Categories of Records

SILive.com's search identified references to underwear, attorney involvement, and autopsy records connected to Staten Island. The outlet did not provide additional details about the specific documents or individuals named in the files.

The findings come as transparency advocates analyze the more than 2,800 pages released by the DOJ. [A study found the release represents only 2% of total Epstein files](/news/2026-02-16-trump-doj-released-only-2-of-epstein-files-study-shows) held by federal agencies.

## Mounting Pressure for Full Release
